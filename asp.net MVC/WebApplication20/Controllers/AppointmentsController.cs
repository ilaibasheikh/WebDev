...
namespace WebApplication20.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AppointmentId,AppointmentDate,Notes,DoctorId,PatientId")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AppointmentId,AppointmentDate,Notes,DoctorId,PatientId")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
